...
// MODIFICATION: Importing USBHostSerial Library
...
void setup() {
  ...
  databits: 8
  */
  usbSerial.begin(9600, 0, 0, 8); // Initialize Serial Connection
                                  // This will make the camera unrecognizable by the computer!
